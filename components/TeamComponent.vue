<template>
  <div class="row">
    <div class="col-4 ms-5 ps-5 mt-5 pt-5">
      <p class="bg-secondary text-center rounded-4 fs-3 text-black-50 me-4 px-2 py-3">
        Our goal is to help you find<br/>
        the bank you have been<br/>
        looking for in an easier and<br/>
        more efficient way. <br/>
      </p>
      <p class="bg-success ms-5 py-3 text-center rounded-4 fs-3 text-white px-2 py-2">
